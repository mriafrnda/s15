...
namespace ConsoleApp1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int[,] m = new int[f, c];
            do { Console.Write("(1)Leer (2)Generar (3)Imprimir (4)Contar (5)Transpuesta (0)Salir ->"); 
                opcion = int.Parse(Console.ReadLine()); Menu(opcion, m, f, c); }
            while (opcion != 0);
        }
      ...
      //1)GENERAR LAS VENTAS DIARIAS (L-V) ENTRE 500-2000 HASTA QUE LA VETA MÁXIMA SEA LA DE DIA VIERNES
    //2)SIMULAR UN JUEGO DE 3 EN RAYA
}
